 ...
 */
package chatsocket;
//ghi dữ liệu và gửi tin nhắn tới các client được kết nối.
...
public class WriteServer {
    ...
    //Gửi thông báo người dùng đăng nhập 
    ...
    //Chuyển đổi danh sách tài khoản thành chuỗi 
    ...
    //Gửi thông báo chung tới tất cả các client
    ...
    //Phản hồi yêu cầu truyền file thành công 
